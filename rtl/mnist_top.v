...
//
//  Hex files (in weights/ folder, relative to this file's location):
//    ../weights/fc1_weights.hex  50176 lines  (784x128/2)
//    ../weights/fc2_weights.hex   4096 lines  (128x64/2)
//    ../weights/fc3_weights.hex   1024 lines  ( 64x32/2)
//    ../weights/fc4_weights.hex    160 lines  ( 32x10/2)
//    ../weights/fc1_bias.hex       128 entries
//    ../weights/fc2_bias.hex        64 entries
//    ../weights/fc3_bias.hex        32 entries
//    ../weights/fc4_bias.hex        10 entries
//
...
module mlp_infer (
    ...
    initial begin
        $readmemh("../weights/fc1_weights.hex", fc1_w);
        $readmemh("../weights/fc2_weights.hex", fc2_w);
        $readmemh("../weights/fc3_weights.hex", fc3_w);
        $readmemh("../weights/fc4_weights.hex", fc4_w);
        $readmemh("../weights/fc1_bias.hex",    fc1_b);
        $readmemh("../weights/fc2_bias.hex",    fc2_b);
        $readmemh("../weights/fc3_bias.hex",    fc3_b);
        $readmemh("../weights/fc4_bias.hex",    fc4_b);
    end
